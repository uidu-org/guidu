...
declare module '@uidu/json-schema-generator';
declare module '@uidu/layer-manager';
declare module '@uidu/layer';
declare module '@uidu/lozenge';
...
declare module '@uidu/portal';
declare module '@uidu/react-experiment-framework';
declare module '@uidu/reduced-ui-pack';
declare module '@uidu/refinement-bar';
declare module '@uidu/select';
declare module '@uidu/single-select';
declare module '@uidu/size-detector';
declare module '@uidu/slider';
declare module '@uidu/spinner';
declare module '@uidu/table-tree';
declare module '@uidu/textfield';
declare module '@uidu/theme/colors';
