...
exports.maybeGetById = maybeGetById;
exports.getById = getById;
exports.flatMap = flatMap;
exports.find = find;
exports.findNormalized = findNormalized;
exports.normalize = normalize;
exports.titleize = titleize;

var _sentenceCase = _interopRequireDefault(require("sentence-case"));

function getDirectories(items) {
  var dirs = [];
  console.log(items);
...
function maybeGetById(items, id) {
...
function findNormalized(dir, filePath) {
...
function titleize(filePath) {
  return (0, _sentenceCase.default)(normalize(filePath));
}