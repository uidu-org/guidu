  ...
  render() {
    ...
    return (
      <MediaEditorContainer style={{ width, height }}>
        ...
        <OutputArea
          ref={this.handleOutputAreaInnerRef}
          style={{ width, height }}
        >
          <SupplementaryCanvas ref={this.handleSupplementaryCanvasInnerRef} />

          <HiddenTextArea
            autoComplete={'off'}
            ref={this.handleHiddenTextAreaInnerRef}
          />

          <HiddenTextHelperDiv ref={this.handleHiddenTextHelperDivInnerRef} />

          <DrawingCanvas
            ref={this.handleDrawingCanvasInnerRef}
            style={{ width, height }}
          />
        </OutputArea>
      </MediaEditorContainer>
