...
import { getCssFromImageOrientation, isRotated } from '@uidu/media-ui';
...
var MediaImage = /** @class */ (function (_super) {
    ...
    MediaImage.prototype.render = function () {
        ...
        */
        ...
        return (React.createElement(ImageComponent, { draggable: false, style: style, onLoad: this.onImageLoad, ref: this.imageRef, src: dataURI }));
    };
