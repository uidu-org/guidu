...
export default {
    ...
    'fabric.media.drag_and_drop_your_files': 'ファイルをここにドラッグ&ドロップ、または',
    ...
    'fabric.media.connect_account_description': '{name} アカウントを接続するため、新ページを開きます',
    ...
    'fabric.media.image_url_invalid_error': '画像を読み込めませんでした。URLが無効です。',
    'fabric.media.image_format_invalid_error': '画像を読み込めませんでした。フォーマットが無効です。',
    'fabric.media.image_size_too_large_error': '画像が大きすぎます。画像サイズは {MAX_SIZE_MB}Mb以下である必要があります。',
    ...
    'fabric.media.no_pdf_artifacts': 'このファイルのPDFアーティファクトが見つかりません。',
    'fabric.media.give_feedback': 'フィードバックを送信',
    'fabric.media.try_downloading_file': 'ファイルを表示するにはダウンロードしてください。',
    'fabric.media.webgl_warning_description': 'お使いのブラウザはWebGLに対応していません。画像にコメントをつけるにはWebGL対応ブラウザをご利用ください。',
    'fabric.media.unable_to_annotate_image': 'この画像にコメントをつけられませんでした',
    ...
    'fabric.media.error_hint_critical': '問題が継続して起きる場合はサポートにご連絡ください。',
