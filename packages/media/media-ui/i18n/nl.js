...
export default {
    ...
    'fabric.media.image_size_too_large_error': 'De afbeelding is te groot. Het mag niet groter zijn dan {MAX_SIZE_MB} MB.',
    ...
    'fabric.media.couldnt_generate_preview': 'Voor dit bestandstype kunnen we geen voorvertoning weergeven.',
    'fabric.media.cant_preview_file_type': 'Voor dit bestandstype kunnen we geen voorvertoning weergeven.',
    ...
    'fabric.media.webgl_warning_description': 'Je browser ondersteunt niet WebGL. Gebruik een browser met WebGL-functie om aantekeningen te maken bij afbeeldingen.',
    ...
    'fabric.media.insert_files': '{0, plural, one{Een bestand invoegen} other{{0} bestanden invoegen}}',
