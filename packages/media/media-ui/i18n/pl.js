...
export default {
    ...
    'fabric.media.no_gifs_found_suggestion': 'Nie udało się znaleźć wyników pasujących do zapytania „{query}”',
    ...
    'fabric.media.image_url_invalid_error': 'Nie udało się załadować obrazu. Adres URL jest niepoprawny.',
    'fabric.media.image_format_invalid_error': 'Nie udało się załadować obrazu. Format jest niepoprawny.',
    'fabric.media.image_size_too_large_error': 'Obraz jest za duży, nie może przekroczyć {MAX_SIZE_MB} MB',
    'fabric.media.something_went_wrong': 'Coś poszło nie tak.',
    'fabric.media.might_be_a_hiccup': 'To musi być przejściowy problem.',
    'fabric.media.couldnt_generate_preview': 'Nie udało się wygenerować podglądu tego pliku.',
    ...
    'fabric.media.unable_to_annotate_image': 'Nie udało się dodać adnotacji do tego obrazu',
    ...
    'fabric.media.insert_files': '{0, plural, one{Wstaw plik} few{Wstaw {0} pliki} many{Wstaw {0} plików} other{Wstaw {0}pliku}}',
    'fabric.media.zoom_out': 'oddal',
    'fabric.media.zoom_in': 'przybliż',
    ...
    'fabric.media.error_loading_file': 'Błąd wczytywania pliku',
