...
export default {
    ...
    'fabric.media.image_size_too_large_error': 'La imagen es demasiado larga; no puede superar los {MAX_SIZE_MB} MB',
    ...
    'fabric.media.insert_files': '{0, plural, one{Insertar un archivo} other{Insertar {0} archivos}}',
