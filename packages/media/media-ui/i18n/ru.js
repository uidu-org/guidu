...
export default {
    ...
    'fabric.media.insert_files': '{0, plural, one{Вставить файл} few{Вставить {0} файла} many{Вставить {0} файлов} other{Вставить {0} файла}}',
    ...
    'fabric.media.error_generating_preview': 'Не удалось выполнить предварительный просмотр',
