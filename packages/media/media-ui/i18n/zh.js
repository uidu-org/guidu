...
export default {
    ...
    'fabric.media.connect_account_description': '我们将打开新页面帮助您连接{name}账户',
    ...
    'fabric.media.image_size_too_large_error': '图像过大，必须小于{MAX_SIZE_MB} MB',
    ...
    'fabric.media.webgl_warning_description': '您的浏览器不支持网页图形库。请使用支持网页图形库的浏览器来标注图像。',
