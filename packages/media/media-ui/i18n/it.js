...
export default {
    ...
    'fabric.media.no_gifs_found_suggestion': 'Non siamo riusciti a trovare nessun risultato per “{query}”',
    ...
    'fabric.media.insert_files': '{0, plural, one{Inserisci un file} other{Inserisci {0} file}}',
