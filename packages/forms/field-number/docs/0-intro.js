...
${code`
import FieldNumber, { FieldNumberStateless } from '@uidu/field-text';
`}
  ...
  ${(
    <Props
      props={require('!!extract-react-types-loader!../src/FieldNumber')}
  ...
  ${(
    <Props
      props={require('!!extract-react-types-loader!../src/FieldNumberStateless')}
      heading="FieldNumberStateless Props"
    />
  )}
