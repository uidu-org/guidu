...
${code`
  npm install @uidu/analytics-listeners
  # or
  yarn add @uidu/analytics-listeners
`}
...
${code`
  ...
  import FabricAnalyticsListeners from '@uidu/analytics-listeners';
  ...
  // Refer to type AnalyticsWebClient from @uidu/analytics-listeners
  ReactDOM.render(
    <div>
