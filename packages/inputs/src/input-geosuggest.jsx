...
export default class InputGeosuggest extends Component {
  constructor(props) {
    super(props);
    if (
  ...
  onFocus = () => {
    ...
    this.geosuggestInput.setSelectionRange(0, 9999);
    if (onFocus) {
      onFocus();
    }
  };
...
InputGeosuggest.defaultProps = {
  ...
  value: '',
  formatAddressFromCoordinates: ({ locality }) => locality.long_name,
  onSuggestSelect: () => {},
  onGeocode: () => {},
};
