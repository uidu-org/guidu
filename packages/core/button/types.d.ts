...
declare type HtmlAttributes = Pick<React.AllHTMLAttributes<HTMLElement>, Exclude<keyof React.AllHTMLAttributes<HTMLElement>, keyof OnlyButtonProps>>;
...
export declare type ButtonProps = HtmlAttributes & OnlyButtonProps;
export declare type ConsumerRef = string | ((instance: HTMLElement | null) => any) | React.RefObject<HTMLElement> | undefined;
