...
function (_Component) {
  ...
  function Checkbox() {
    ...
    _this.renderElement = function () {
      ...
      return _react.default.createElement(_reactstrap.CustomInput, (0, _extends2.default)({}, inputProps, {
        type: "checkbox",
        disabled: disabled,
        id: id,
        label: label,
...
Checkbox.propTypes = (0, _objectSpread2.default)({}, _fieldBase.ComponentCommon.propTypes, _reactstrap.CustomInput.propTypes); // CustomInput.propTypes = {
