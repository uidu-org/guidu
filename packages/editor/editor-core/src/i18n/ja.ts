...
export default {
  ...
  'fabric.editor.heading2Description': 'キーセクションに使用',
  ...
  'fabric.editor.heading5Description': 'グループのリストアイテムに使用',
  ...
  'fabric.editor.infoPanel.description': '色付きのパネルで情報をハイライト',
  ...
  'fabric.editor.errorPanel.description': '色付きのパネルでエラーを呼び出し',
  ...
  'fabric.editor.action.description': 'アクション項目を作成して割り当て',
