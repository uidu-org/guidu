    ...
    { type: 'paragraph', content: [] },
    {
      ...
      content: [
        ...
        { type: 'text', text: ', limitare il contagio è fondamentale. ' },
        {
          type: 'text',
          text:
            'C’è però chi può attrezzarsi meglio a resistere in questi tempi difficili e chi invece sta vivendo in questi giorni una situazione drammatica.',
          marks: [{ type: 'strong' }],
        },
      ],
    },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'text',
          text:
            'acquisto dei pacchi spesa, l’acquisto e la distribuzione di dispositivi di protezione minima consigliati, il supporto alle fasce sociali più a rischio - come gli anziani - per limitare le uscite e i contatti.',
          marks: [{ type: 'strong' }],
        },
        { type: 'hardBreak' },
        {
      ...
      content: [
        {
          type: 'text',
          text:
            'Coronavirus is highly contagious, we have to stop its spreading. ',
        },
        {
          type: 'text',
          text:
            'Some people, though, can resist better in these hard times while others are forced to face a dramatic situation.',
          marks: [{ type: 'strong' }],
        },
      ],
    },
