...
${code`
import { ReactRenderer } from '@uidu/renderer';
...
${code`
import { BitbucketTransformer } from '@uidu/editor-bitbucket-transformer';
import { ReactRenderer, ADFEncoder } from '@uidu/renderer';
...
${(
  <Example
    ...
    title="Truncated"
    source={require('!!raw-loader!../examples/15-truncated').default}
  />
)}
