...
export default class More extends Component<any> {
  render() {
    ...
    return (
      ...
      >
        <DropdownItemGroup>
          <DropdownItem onClick={onDownload} elemBefore={<DownloadCloud size={14} />}>Download CSV</DropdownItem>
          <DropdownItem onClick={onDuplicate} elemBefore={<Copy size={14} />}>Duplicate</DropdownItem>
        </DropdownItemGroup>
      </DropdownMenu>
    );
  }
