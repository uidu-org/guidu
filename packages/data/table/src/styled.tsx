...
export const Td = styled.div.attrs<StyledTdProps>((props) => ({
  ...
  ${tw`flex flex-auto items-center px-4 border-b border-r whitespace-nowrap`}
`;
...
export const Th = styled.div.attrs<ThProps>((props: ThProps) => ({
  ...
  ${tw`relative flex-auto flex items-center px-4 text-left [color:rgb(var(--body-secondary-color))] border-b border-r whitespace-nowrap`}
`;
