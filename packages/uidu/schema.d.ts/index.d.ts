...
export type Account = ActiveRecordTimestamp & Node & WithAddresses & WithAvatar & WithFieldValues & {
  ...
  fieldValues?: Maybe<Scalars['JSON']>;
...
export type ColumnsStateAttribute = {
  columnDefinitions?: Maybe<Scalars['JSON']>;
  columnResizing?: Maybe<DataViewStateColumnResizing>;
  expanded?: Maybe<Scalars['JSON']>;
  ...
  selectedRowIds?: Maybe<Scalars['JSON']>;
...
export type Contact = ActiveRecordTimestamp & Node & WithAddresses & WithAvatar & WithFieldValues & {
...
export type ContactApplicationArgs = {
  id: Scalars['ID'];
};
...
export type ContactSubscriptionArgs = {
  id: Scalars['ID'];
};
...
export type CreateFieldInput = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  fieldParentId?: Maybe<Scalars['ID']>;
};
...
/** Autogenerated input type of CreateFormQuestion */
export type CreateFormQuestionInput = {
  attributes: FormQuestionAttributes;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  fieldId: Scalars['ID'];
  formId: Scalars['ID'];
...
/** Autogenerated return type of CreateFormQuestion */
export type CreateFormQuestionPayload = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  errors: Array<Scalars['String']>;
  formQuestion?: Maybe<FormQuestion>;
};

/** Autogenerated input type of CreateFormResponse */
...
/** Autogenerated return type of CreateFormResponse */
...
export type DataViewStateColumnResizing = {
  columnWidth?: Maybe<Scalars['Int']>;
  columnWidths?: Maybe<Scalars['JSON']>;
  headerIdWidths?: Maybe<Scalars['JSON']>;
  isResizingColumn?: Maybe<Scalars['Boolean']>;
  startX?: Maybe<Scalars['Int']>;
};
...
/** Autogenerated input type of DeleteFormQuestion */
...
/** Autogenerated return type of DeleteFormQuestion */
export type DeleteFormQuestionPayload = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  errors: Array<Scalars['String']>;
  formQuestion?: Maybe<FormQuestion>;
...
/** Autogenerated input type of DeleteFormResponse */
...
/** Autogenerated return type of DeleteFormResponse */
...
export type DonationCampaign = ActiveRecordTimestamp & Node & WithAddresses & WithCover & WithDataViews & WithFieldValues & WithOrganization & WithPaths & WithPost & WithPreferences & WithProducts & WithPublishable & WithWysiwyg & {
  abstract?: Maybe<Scalars['String']>;
  addresses: Array<Address>;
  adminPath?: Maybe<Scalars['String']>;
  adminUrl?: Maybe<Scalars['String']>;
...
export type Event = ActiveRecordTimestamp & Node & WithAddresses & WithCover & WithOrganization & WithPost & WithPreferences & WithWysiwyg & {
  addresses: Array<Address>;
...
export type EventAttributes = {
  body?: Maybe<Scalars['JSON']>;
  cover?: Maybe<Scalars['JSON']>;
  eventInstancesAttributes?: Maybe<Array<EventInstanceAttributes>>;
...
export type Field = ActiveRecordTimestamp & Node & WithOrganization & WithPreferences & {
  createdAt: Scalars['ISO8601DateTime'];
  description?: Maybe<Scalars['String']>;
  fieldOptions?: Maybe<Array<FieldOption>>;
...
export type FieldAttributes = {
  description?: Maybe<Scalars['String']>;
  fieldOptionsAttributes?: Maybe<Array<FieldOptionAttributes>>;
...
export type FieldOption = ActiveRecordTimestamp & Node & WithOrganization & WithPreferences & {
  color?: Maybe<Scalars['String']>;
  createdAt: Scalars['ISO8601DateTime'];
  id: Scalars['ID'];
  name?: Maybe<Scalars['String']>;
...
/** Attributes for creating or updating a custom field */
export type FieldOptionAttributes = {
  color?: Maybe<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
  position?: Maybe<Scalars['Int']>;
  preferences?: Maybe<Scalars['JSON']>;
...
export type Form = ActiveRecordTimestamp & Node & WithOrganization & {
  createdAt: Scalars['ISO8601DateTime'];
  description?: Maybe<Scalars['String']>;
  formQuestions?: Maybe<Array<FormQuestion>>;
  id: Scalars['ID'];
  name?: Maybe<Scalars['String']>;
  organization?: Maybe<Organization>;
  updatedAt: Scalars['ISO8601DateTime'];
...
export type FormQuestion = ActiveRecordTimestamp & Node & WithPreferences & {
  createdAt: Scalars['ISO8601DateTime'];
  /** DonationCampaign associated to this donation */
  field?: Maybe<Field>;
  form?: Maybe<Form>;
...
export type FormQuestionAttributes = {
  fieldAttributes?: Maybe<FieldAttributes>;
  hint?: Maybe<Scalars['String']>;
  label?: Maybe<Scalars['String']>;
  placeholder?: Maybe<Scalars['String']>;
  position?: Maybe<Scalars['Int']>;
...
export type FormResponse = Node & {
  ...
  responsableType?: Maybe<Scalars['String']>;
  updatedAt: Scalars['ISO8601DateTime'];
};
...
export type Mutation = Node & {
  ...
  createFormQuestion?: Maybe<CreateFormQuestionPayload>;
  ...
  deleteFormQuestion?: Maybe<DeleteFormQuestionPayload>;
  ...
  updateFormQuestion?: Maybe<UpdateFormQuestionPayload>;
...
export type Organization = ActiveRecordTimestamp & Node & WithAddresses & WithAvatar & WithPost & {
  ...
  visitEventsConnection?: Maybe<VisitEventConnection>;
  visits?: Maybe<Array<Visit>>;
  visitsConnection?: Maybe<VisitConnection>;
};
...
export type OrganizationCallArgs = {
  id: Scalars['ID'];
};
...
export type OrganizationDonationArgs = {
  id: Scalars['ID'];
};
...
export type OrganizationVisitEventsArgs = {
  kind?: Maybe<Scalars['String']>;
};


export type OrganizationVisitEventsConnectionArgs = {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
export type OrganizationVisitsConnectionArgs = {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
/** Autogenerated input type of UpdateFormQuestion */
...
/** Autogenerated return type of UpdateFormQuestion */
export type UpdateFormQuestionPayload = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  errors: Array<Scalars['String']>;
  formQuestion?: Maybe<FormQuestion>;
...
/** Autogenerated input type of UpdateFormResponse */
...
/** Autogenerated return type of UpdateFormResponse */
...
export type VisitEvent = Node & {
  /** ID of the object. */
  id: Scalars['ID'];
};

/** The connection type for VisitEvent. */
export type VisitEventConnection = {
  /** A list of edges. */
  edges?: Maybe<Array<Maybe<VisitEventEdge>>>;
  /** A list of nodes. */
  nodes?: Maybe<Array<Maybe<VisitEvent>>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

/** An edge in a connection. */
export type VisitEventEdge = {
  /** A cursor for use in pagination. */
  cursor: Scalars['String'];
  /** The item at the end of the edge. */
  node?: Maybe<VisitEvent>;
};
