...
exports.default = insertStyleSheetInHead;
 ...
 */
function insertStyleSheetInHead(cssResetStyles) {
  var parentElement = document.head || document.body;

  if (parentElement) {
    var insertBeforeElement = document.getElementsByTagName('style')[0] || parentElement.firstChild;
