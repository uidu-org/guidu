...
describe('Navigation Next: getAnimationStyles', () => {
  ...
  describe('When state is `entering`', () => {
    it('should add different animations based on traversal direction', () => {
      const down = getAnimationStyles({ ...commonTransitionalEnteringStyles,
    ...
    it('should add the specific styles for the animation', () => {
      expect(getAnimationStyles(commonTransitionalEnteringStyles)).toMatchObject({
        position: 'absolute',
        width: '100%'
      });
    });
  ...
  describe('When state is `exiting`', () => {
    it('should add different animations based on traversal direction', () => {
      const down = getAnimationStyles({ ...commonTransitionalExitingStyles,
        traversalDirection: 'down'
      });
